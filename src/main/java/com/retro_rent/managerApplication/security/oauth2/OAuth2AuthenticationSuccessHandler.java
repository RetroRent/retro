...
import com.retro_rent.managerApplication.security.util.CookieUtils;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    @Value("${spring.app.auth2.authorizedRedirectUris}")
    ...
    {
        String[] results = authorizedRedirectUris.split(",");
